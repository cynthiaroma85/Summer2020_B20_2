...
public class Developer {  // in order to have many classes in one file
                          // only ONE class can be public and have same name like FILE
    ...
    // instance method doesnt have Static
...
class DeveloperObject{  // CLASS !! cannot be public anymore
    ...
    public static void main(String[] args) {
        ...
        }  // since [i] is a Element we can call a instanec method!
