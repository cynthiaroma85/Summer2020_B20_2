...
// unchecked exception => use RuntimeException
// checked exception=> InterruptedException
// for MULTI Catch block, get first one that handle the exception! parent cant go after child class
// .... also only one block get executed
// "finally block" it ALWAYS get Executed even if is handled or not. But next code WONT get executed
