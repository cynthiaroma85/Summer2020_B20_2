...
public class String_Method2 {
    public static void main(String[] args) {
        ...
        System.out.println( str1.equals(str2)  ); //true as a ext string
        ...
        System.out.println(str7.equals(str8) ); // FALSE because of case sensitive
        ...
        System.out.println(s1.endsWith("AR")); // false case sensitive
        System.out.println(s1.toUpperCase().endsWith("AR")); //true
