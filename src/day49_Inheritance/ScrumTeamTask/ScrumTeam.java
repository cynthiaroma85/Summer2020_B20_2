...
public class ScrumTeam {
    ...
    public ArrayList<Tester> testers = new ArrayList<>();  // instance variable of array
    public ArrayList<Developer> developers = new ArrayList<>();

    //constructor get executed as soon as object is created, intead of setInfo
    ...
    public void addTester(Tester tester) {  // void because we will not return anything PLUS is instance variab
        testers.add(tester);
    }
    ...
    public void addTesters(Tester[] testers){
        // local variable same name like my Instance variable so we need this. to added to the local
