...
public class Person {
    ...
    private long ssn; // PRIVATE we dont want this to be inherited to the sub classes
    ...
    private void eat(){ // PRIVATE we dont want this to be inherited to the sub classes
